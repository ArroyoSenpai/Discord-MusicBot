	...
	nodes: [
		{
			...
			host: "skycodes1.ssph.live", //- The host name or IP of the lavalink server.
			port: 15785, // The port that lavalink is listening to. This must be a number!
			password: "skycodes", //- The password of the lavalink server.
